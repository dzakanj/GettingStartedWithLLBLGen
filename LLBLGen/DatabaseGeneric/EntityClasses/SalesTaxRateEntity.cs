...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _stateProvince, new PropertyChangedEventHandler(OnStateProvincePropertyChanged), "StateProvince", "SalesTaxRates", AdventureWorksLLBLGen.RelationClasses.StaticSalesTaxRateRelations.StateProvinceEntityUsingStateProvinceIdStatic, true, new int[] { (int)SalesTaxRateFieldIndex.StateProvinceId });
		}
		...
		{
			SetupSync(relatedEntity, ref _stateProvince, new PropertyChangedEventHandler( OnStateProvincePropertyChanged ), "StateProvince", "SalesTaxRates", AdventureWorksLLBLGen.RelationClasses.StaticSalesTaxRateRelations.StateProvinceEntityUsingStateProvinceIdStatic, true, new string[] {  }, new int[] { (int)SalesTaxRateFieldIndex.StateProvinceId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StateProvinceEntityFactory))),	(IEntityRelation)GetRelationsForField("StateProvince")[0], (int)AdventureWorksLLBLGen.EntityType.SalesTaxRateEntity, (int)AdventureWorksLLBLGen.EntityType.StateProvinceEntity, 0, null, null, null, null, "StateProvince", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SalesTaxRateEntity; }
		}
