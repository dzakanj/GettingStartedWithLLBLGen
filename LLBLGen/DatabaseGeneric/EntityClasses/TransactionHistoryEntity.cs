...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "TransactionHistories", AdventureWorksLLBLGen.RelationClasses.StaticTransactionHistoryRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)TransactionHistoryFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "TransactionHistories", AdventureWorksLLBLGen.RelationClasses.StaticTransactionHistoryRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)TransactionHistoryFieldIndex.ProductId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorksLLBLGen.EntityType.TransactionHistoryEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.TransactionHistoryEntity; }
		}
