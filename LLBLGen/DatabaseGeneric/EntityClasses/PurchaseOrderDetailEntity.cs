...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "PurchaseOrderDetails", AdventureWorksLLBLGen.RelationClasses.StaticPurchaseOrderDetailRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)PurchaseOrderDetailFieldIndex.ProductId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderDetailEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PurchaseOrderHeaderEntityFactory))),	(IEntityRelation)GetRelationsForField("PurchaseOrderHeader")[0], (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderDetailEntity, (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderHeaderEntity, 0, null, null, null, null, "PurchaseOrderHeader", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderDetailEntity; }
		}
