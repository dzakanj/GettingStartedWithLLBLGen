...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<CurrencyRateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyRateEntityFactory))), (IEntityRelation)GetRelationsForField("CurrencyRates")[0], (int)AdventureWorksLLBLGen.EntityType.CurrencyEntity, (int)AdventureWorksLLBLGen.EntityType.CurrencyRateEntity, 0, null, null, null, null, "CurrencyRates", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<CurrencyRateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyRateEntityFactory))), (IEntityRelation)GetRelationsForField("CurrencyRates1")[0], (int)AdventureWorksLLBLGen.EntityType.CurrencyEntity, (int)AdventureWorksLLBLGen.EntityType.CurrencyRateEntity, 0, null, null, null, null, "CurrencyRates1", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.CurrencyEntity; }
		}
