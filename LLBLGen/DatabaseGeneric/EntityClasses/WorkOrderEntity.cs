...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "WorkOrders", AdventureWorksLLBLGen.RelationClasses.StaticWorkOrderRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)WorkOrderFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "WorkOrders", AdventureWorksLLBLGen.RelationClasses.StaticWorkOrderRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)WorkOrderFieldIndex.ProductId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _scrapReason, new PropertyChangedEventHandler(OnScrapReasonPropertyChanged), "ScrapReason", "WorkOrders", AdventureWorksLLBLGen.RelationClasses.StaticWorkOrderRelations.ScrapReasonEntityUsingScrapReasonIdStatic, true, new int[] { (int)WorkOrderFieldIndex.ScrapReasonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _scrapReason, new PropertyChangedEventHandler( OnScrapReasonPropertyChanged ), "ScrapReason", "WorkOrders", AdventureWorksLLBLGen.RelationClasses.StaticWorkOrderRelations.ScrapReasonEntityUsingScrapReasonIdStatic, true, new string[] {  }, new int[] { (int)WorkOrderFieldIndex.ScrapReasonId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<WorkOrderRoutingEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderRoutingEntityFactory))), (IEntityRelation)GetRelationsForField("WorkOrderRoutings")[0], (int)AdventureWorksLLBLGen.EntityType.WorkOrderEntity, (int)AdventureWorksLLBLGen.EntityType.WorkOrderRoutingEntity, 0, null, null, null, null, "WorkOrderRoutings", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorksLLBLGen.EntityType.WorkOrderEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ScrapReasonEntityFactory))),	(IEntityRelation)GetRelationsForField("ScrapReason")[0], (int)AdventureWorksLLBLGen.EntityType.WorkOrderEntity, (int)AdventureWorksLLBLGen.EntityType.ScrapReasonEntity, 0, null, null, null, null, "ScrapReason", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.WorkOrderEntity; }
		}
