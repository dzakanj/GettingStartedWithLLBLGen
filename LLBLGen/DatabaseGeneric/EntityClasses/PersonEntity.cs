...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "Person", AdventureWorksLLBLGen.RelationClasses.StaticPersonRelations.EmployeeEntityUsingBusinessEntityIdStatic, false, new int[] { (int)PersonFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "Person", AdventureWorksLLBLGen.RelationClasses.StaticPersonRelations.EmployeeEntityUsingBusinessEntityIdStatic, false, new string[] {  }, new int[] { (int)PersonFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _businessEntity, new PropertyChangedEventHandler(OnBusinessEntityPropertyChanged), "BusinessEntity", "Person", AdventureWorksLLBLGen.RelationClasses.StaticPersonRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new int[] { (int)PersonFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", "Person", AdventureWorksLLBLGen.RelationClasses.StaticPersonRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)PersonFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _password, new PropertyChangedEventHandler(OnPasswordPropertyChanged), "Password", "Person", AdventureWorksLLBLGen.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, false, new int[] { (int)PersonFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _password, new PropertyChangedEventHandler( OnPasswordPropertyChanged ), "Password", "Person", AdventureWorksLLBLGen.RelationClasses.StaticPersonRelations.PasswordEntityUsingBusinessEntityIdStatic, false, new string[] {  }, new int[] { (int)PersonFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<BusinessEntityContactEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BusinessEntityContactEntityFactory))), (IEntityRelation)GetRelationsForField("BusinessEntityContacts")[0], (int)AdventureWorksLLBLGen.EntityType.PersonEntity, (int)AdventureWorksLLBLGen.EntityType.BusinessEntityContactEntity, 0, null, null, null, null, "BusinessEntityContacts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmailAddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmailAddressEntityFactory))), (IEntityRelation)GetRelationsForField("EmailAddresses")[0], (int)AdventureWorksLLBLGen.EntityType.PersonEntity, (int)AdventureWorksLLBLGen.EntityType.EmailAddressEntity, 0, null, null, null, null, "EmailAddresses", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<PersonPhoneEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PersonPhoneEntityFactory))), (IEntityRelation)GetRelationsForField("PersonPhones")[0], (int)AdventureWorksLLBLGen.EntityType.PersonEntity, (int)AdventureWorksLLBLGen.EntityType.PersonPhoneEntity, 0, null, null, null, null, "PersonPhones", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), (IEntityRelation)GetRelationsForField("Customers")[0], (int)AdventureWorksLLBLGen.EntityType.PersonEntity, (int)AdventureWorksLLBLGen.EntityType.CustomerEntity, 0, null, null, null, null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<PersonCreditCardEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PersonCreditCardEntityFactory))), (IEntityRelation)GetRelationsForField("PersonCreditCards")[0], (int)AdventureWorksLLBLGen.EntityType.PersonEntity, (int)AdventureWorksLLBLGen.EntityType.PersonCreditCardEntity, 0, null, null, null, null, "PersonCreditCards", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), (IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorksLLBLGen.EntityType.PersonEntity, (int)AdventureWorksLLBLGen.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(BusinessEntityEntityFactory))), (IEntityRelation)GetRelationsForField("BusinessEntity")[0], (int)AdventureWorksLLBLGen.EntityType.PersonEntity, (int)AdventureWorksLLBLGen.EntityType.BusinessEntityEntity, 0, null, null, null, null, "BusinessEntity", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PasswordEntityFactory))), (IEntityRelation)GetRelationsForField("Password")[0], (int)AdventureWorksLLBLGen.EntityType.PersonEntity, (int)AdventureWorksLLBLGen.EntityType.PasswordEntity, 0, null, null, null, null, "Password", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.PersonEntity; }
		}
