...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesPerson, new PropertyChangedEventHandler(OnSalesPersonPropertyChanged), "SalesPerson", "SalesTerritoryHistories", AdventureWorksLLBLGen.RelationClasses.StaticSalesTerritoryHistoryRelations.SalesPersonEntityUsingBusinessEntityIdStatic, true, new int[] { (int)SalesTerritoryHistoryFieldIndex.BusinessEntityId });
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesTerritory, new PropertyChangedEventHandler(OnSalesTerritoryPropertyChanged), "SalesTerritory", "SalesTerritoryHistories", AdventureWorksLLBLGen.RelationClasses.StaticSalesTerritoryHistoryRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new int[] { (int)SalesTerritoryHistoryFieldIndex.TerritoryId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", "SalesTerritoryHistories", AdventureWorksLLBLGen.RelationClasses.StaticSalesTerritoryHistoryRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  }, new int[] { (int)SalesTerritoryHistoryFieldIndex.TerritoryId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryHistoryEntity, (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesTerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesTerritory")[0], (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryHistoryEntity, (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, 0, null, null, null, null, "SalesTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryHistoryEntity; }
		}
