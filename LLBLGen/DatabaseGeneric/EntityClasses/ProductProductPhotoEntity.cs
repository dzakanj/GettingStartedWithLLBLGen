...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "ProductProductPhotos", AdventureWorksLLBLGen.RelationClasses.StaticProductProductPhotoRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)ProductProductPhotoFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ProductProductPhotos", AdventureWorksLLBLGen.RelationClasses.StaticProductProductPhotoRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ProductProductPhotoFieldIndex.ProductId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _productPhoto, new PropertyChangedEventHandler(OnProductPhotoPropertyChanged), "ProductPhoto", "ProductProductPhotos", AdventureWorksLLBLGen.RelationClasses.StaticProductProductPhotoRelations.ProductPhotoEntityUsingProductPhotoIdStatic, true, new int[] { (int)ProductProductPhotoFieldIndex.ProductPhotoId });
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorksLLBLGen.EntityType.ProductProductPhotoEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductPhotoEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductPhoto")[0], (int)AdventureWorksLLBLGen.EntityType.ProductProductPhotoEntity, (int)AdventureWorksLLBLGen.EntityType.ProductPhotoEntity, 0, null, null, null, null, "ProductPhoto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.ProductProductPhotoEntity; }
		}
