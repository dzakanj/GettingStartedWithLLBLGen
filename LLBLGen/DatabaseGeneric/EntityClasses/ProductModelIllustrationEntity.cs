...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IllustrationEntityFactory))),	(IEntityRelation)GetRelationsForField("Illustration")[0], (int)AdventureWorksLLBLGen.EntityType.ProductModelIllustrationEntity, (int)AdventureWorksLLBLGen.EntityType.IllustrationEntity, 0, null, null, null, null, "Illustration", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductModelEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductModel")[0], (int)AdventureWorksLLBLGen.EntityType.ProductModelIllustrationEntity, (int)AdventureWorksLLBLGen.EntityType.ProductModelEntity, 0, null, null, null, null, "ProductModel", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.ProductModelIllustrationEntity; }
		}
