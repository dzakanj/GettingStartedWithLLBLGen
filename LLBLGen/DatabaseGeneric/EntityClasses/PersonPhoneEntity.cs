...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _person, new PropertyChangedEventHandler(OnPersonPropertyChanged), "Person", "PersonPhones", AdventureWorksLLBLGen.RelationClasses.StaticPersonPhoneRelations.PersonEntityUsingBusinessEntityIdStatic, true, new int[] { (int)PersonPhoneFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "PersonPhones", AdventureWorksLLBLGen.RelationClasses.StaticPersonPhoneRelations.PersonEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)PersonPhoneFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PersonEntityFactory))),	(IEntityRelation)GetRelationsForField("Person")[0], (int)AdventureWorksLLBLGen.EntityType.PersonPhoneEntity, (int)AdventureWorksLLBLGen.EntityType.PersonEntity, 0, null, null, null, null, "Person", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PhoneNumberTypeEntityFactory))),	(IEntityRelation)GetRelationsForField("PhoneNumberType")[0], (int)AdventureWorksLLBLGen.EntityType.PersonPhoneEntity, (int)AdventureWorksLLBLGen.EntityType.PhoneNumberTypeEntity, 0, null, null, null, null, "PhoneNumberType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.PersonPhoneEntity; }
		}
