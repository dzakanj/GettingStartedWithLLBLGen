...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _countryRegion, new PropertyChangedEventHandler(OnCountryRegionPropertyChanged), "CountryRegion", "SalesTerritories", AdventureWorksLLBLGen.RelationClasses.StaticSalesTerritoryRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, new int[] { (int)SalesTerritoryFieldIndex.CountryRegionCode });
		}
		...
		{
			SetupSync(relatedEntity, ref _countryRegion, new PropertyChangedEventHandler( OnCountryRegionPropertyChanged ), "CountryRegion", "SalesTerritories", AdventureWorksLLBLGen.RelationClasses.StaticSalesTerritoryRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, new string[] {  }, new int[] { (int)SalesTerritoryFieldIndex.CountryRegionCode }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<StateProvinceEntity>(EntityFactoryCache2.GetEntityFactory(typeof(StateProvinceEntityFactory))), (IEntityRelation)GetRelationsForField("StateProvinces")[0], (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, (int)AdventureWorksLLBLGen.EntityType.StateProvinceEntity, 0, null, null, null, null, "StateProvinces", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), (IEntityRelation)GetRelationsForField("Customers")[0], (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, (int)AdventureWorksLLBLGen.EntityType.CustomerEntity, 0, null, null, null, null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaders")[0], (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, 0, null, null, null, null, "SalesOrderHeaders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesPersonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))), (IEntityRelation)GetRelationsForField("SalesPeople")[0], (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPeople", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CountryRegionEntityFactory))),	(IEntityRelation)GetRelationsForField("CountryRegion")[0], (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, (int)AdventureWorksLLBLGen.EntityType.CountryRegionEntity, 0, null, null, null, null, "CountryRegion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity; }
		}
