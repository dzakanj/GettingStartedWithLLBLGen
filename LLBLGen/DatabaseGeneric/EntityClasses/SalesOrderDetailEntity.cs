...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesOrderHeader, new PropertyChangedEventHandler(OnSalesOrderHeaderPropertyChanged), "SalesOrderHeader", "SalesOrderDetails", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderDetailRelations.SalesOrderHeaderEntityUsingSalesOrderIdStatic, true, new int[] { (int)SalesOrderDetailFieldIndex.SalesOrderId });
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _specialOfferProduct, new PropertyChangedEventHandler(OnSpecialOfferProductPropertyChanged), "SpecialOfferProduct", "SalesOrderDetails", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderDetailRelations.SpecialOfferProductEntityUsingProductIdSpecialOfferIdStatic, true, new int[] { (int)SalesOrderDetailFieldIndex.ProductId, (int)SalesOrderDetailFieldIndex.SpecialOfferId });
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SpecialOfferProductEntityFactory))),	(IEntityRelation)GetRelationsForField("SpecialOfferProduct")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderDetailEntity, (int)AdventureWorksLLBLGen.EntityType.SpecialOfferProductEntity, 0, null, null, null, null, "SpecialOfferProduct", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SalesOrderDetailEntity; }
		}
