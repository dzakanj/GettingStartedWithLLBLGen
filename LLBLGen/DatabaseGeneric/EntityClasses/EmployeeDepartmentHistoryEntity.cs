...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _department, new PropertyChangedEventHandler(OnDepartmentPropertyChanged), "Department", "EmployeeDepartmentHistories", AdventureWorksLLBLGen.RelationClasses.StaticEmployeeDepartmentHistoryRelations.DepartmentEntityUsingDepartmentIdStatic, true, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.DepartmentId });
		}
		...
		{
			SetupSync(relatedEntity, ref _department, new PropertyChangedEventHandler( OnDepartmentPropertyChanged ), "Department", "EmployeeDepartmentHistories", AdventureWorksLLBLGen.RelationClasses.StaticEmployeeDepartmentHistoryRelations.DepartmentEntityUsingDepartmentIdStatic, true, new string[] {  }, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.DepartmentId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "EmployeeDepartmentHistories", AdventureWorksLLBLGen.RelationClasses.StaticEmployeeDepartmentHistoryRelations.EmployeeEntityUsingBusinessEntityIdStatic, true, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "EmployeeDepartmentHistories", AdventureWorksLLBLGen.RelationClasses.StaticEmployeeDepartmentHistoryRelations.EmployeeEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _shift, new PropertyChangedEventHandler(OnShiftPropertyChanged), "Shift", "EmployeeDepartmentHistories", AdventureWorksLLBLGen.RelationClasses.StaticEmployeeDepartmentHistoryRelations.ShiftEntityUsingShiftIdStatic, true, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.ShiftId });
		}
		...
		{
			SetupSync(relatedEntity, ref _shift, new PropertyChangedEventHandler( OnShiftPropertyChanged ), "Shift", "EmployeeDepartmentHistories", AdventureWorksLLBLGen.RelationClasses.StaticEmployeeDepartmentHistoryRelations.ShiftEntityUsingShiftIdStatic, true, new string[] {  }, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.ShiftId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(DepartmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Department")[0], (int)AdventureWorksLLBLGen.EntityType.EmployeeDepartmentHistoryEntity, (int)AdventureWorksLLBLGen.EntityType.DepartmentEntity, 0, null, null, null, null, "Department", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorksLLBLGen.EntityType.EmployeeDepartmentHistoryEntity, (int)AdventureWorksLLBLGen.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShiftEntityFactory))),	(IEntityRelation)GetRelationsForField("Shift")[0], (int)AdventureWorksLLBLGen.EntityType.EmployeeDepartmentHistoryEntity, (int)AdventureWorksLLBLGen.EntityType.ShiftEntity, 0, null, null, null, null, "Shift", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.EmployeeDepartmentHistoryEntity; }
		}
