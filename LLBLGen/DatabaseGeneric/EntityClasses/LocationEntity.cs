...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductInventoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductInventoryEntityFactory))), (IEntityRelation)GetRelationsForField("ProductInventories")[0], (int)AdventureWorksLLBLGen.EntityType.LocationEntity, (int)AdventureWorksLLBLGen.EntityType.ProductInventoryEntity, 0, null, null, null, null, "ProductInventories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<WorkOrderRoutingEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderRoutingEntityFactory))), (IEntityRelation)GetRelationsForField("WorkOrderRoutings")[0], (int)AdventureWorksLLBLGen.EntityType.LocationEntity, (int)AdventureWorksLLBLGen.EntityType.WorkOrderRoutingEntity, 0, null, null, null, null, "WorkOrderRoutings", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.LocationEntity; }
		}
