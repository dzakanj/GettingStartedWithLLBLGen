...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _currency, new PropertyChangedEventHandler(OnCurrencyPropertyChanged), "Currency", "CurrencyRates", AdventureWorksLLBLGen.RelationClasses.StaticCurrencyRateRelations.CurrencyEntityUsingFromCurrencyCodeStatic, true, new int[] { (int)CurrencyRateFieldIndex.FromCurrencyCode });
		}
		...
		{
			SetupSync(relatedEntity, ref _currency, new PropertyChangedEventHandler( OnCurrencyPropertyChanged ), "Currency", "CurrencyRates", AdventureWorksLLBLGen.RelationClasses.StaticCurrencyRateRelations.CurrencyEntityUsingFromCurrencyCodeStatic, true, new string[] {  }, new int[] { (int)CurrencyRateFieldIndex.FromCurrencyCode }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _currency1, new PropertyChangedEventHandler(OnCurrency1PropertyChanged), "Currency1", "CurrencyRates1", AdventureWorksLLBLGen.RelationClasses.StaticCurrencyRateRelations.CurrencyEntityUsingToCurrencyCodeStatic, true, new int[] { (int)CurrencyRateFieldIndex.ToCurrencyCode });
		}
		...
		{
			SetupSync(relatedEntity, ref _currency1, new PropertyChangedEventHandler( OnCurrency1PropertyChanged ), "Currency1", "CurrencyRates1", AdventureWorksLLBLGen.RelationClasses.StaticCurrencyRateRelations.CurrencyEntityUsingToCurrencyCodeStatic, true, new string[] {  }, new int[] { (int)CurrencyRateFieldIndex.ToCurrencyCode }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaders")[0], (int)AdventureWorksLLBLGen.EntityType.CurrencyRateEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, 0, null, null, null, null, "SalesOrderHeaders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyEntityFactory))),	(IEntityRelation)GetRelationsForField("Currency")[0], (int)AdventureWorksLLBLGen.EntityType.CurrencyRateEntity, (int)AdventureWorksLLBLGen.EntityType.CurrencyEntity, 0, null, null, null, null, "Currency", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyEntityFactory))),	(IEntityRelation)GetRelationsForField("Currency1")[0], (int)AdventureWorksLLBLGen.EntityType.CurrencyRateEntity, (int)AdventureWorksLLBLGen.EntityType.CurrencyEntity, 0, null, null, null, null, "Currency1", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.CurrencyRateEntity; }
		}
