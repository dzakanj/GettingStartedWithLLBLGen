...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _person, new PropertyChangedEventHandler(OnPersonPropertyChanged), "Person", "Customers", AdventureWorksLLBLGen.RelationClasses.StaticCustomerRelations.PersonEntityUsingPersonIdStatic, true, new int[] { (int)CustomerFieldIndex.PersonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "Customers", AdventureWorksLLBLGen.RelationClasses.StaticCustomerRelations.PersonEntityUsingPersonIdStatic, true, new string[] {  }, new int[] { (int)CustomerFieldIndex.PersonId }); 
		}
		...
		{
			SetupSync(relatedEntity, ref _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", "Customers", AdventureWorksLLBLGen.RelationClasses.StaticCustomerRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  }, new int[] { (int)CustomerFieldIndex.TerritoryId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _store, new PropertyChangedEventHandler(OnStorePropertyChanged), "Store", "Customers", AdventureWorksLLBLGen.RelationClasses.StaticCustomerRelations.StoreEntityUsingStoreIdStatic, true, new int[] { (int)CustomerFieldIndex.StoreId });
		}
		...
		{
			SetupSync(relatedEntity, ref _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", "Customers", AdventureWorksLLBLGen.RelationClasses.StaticCustomerRelations.StoreEntityUsingStoreIdStatic, true, new string[] {  }, new int[] { (int)CustomerFieldIndex.StoreId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaders")[0], (int)AdventureWorksLLBLGen.EntityType.CustomerEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, 0, null, null, null, null, "SalesOrderHeaders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PersonEntityFactory))),	(IEntityRelation)GetRelationsForField("Person")[0], (int)AdventureWorksLLBLGen.EntityType.CustomerEntity, (int)AdventureWorksLLBLGen.EntityType.PersonEntity, 0, null, null, null, null, "Person", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesTerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesTerritory")[0], (int)AdventureWorksLLBLGen.EntityType.CustomerEntity, (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, 0, null, null, null, null, "SalesTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StoreEntityFactory))),	(IEntityRelation)GetRelationsForField("Store")[0], (int)AdventureWorksLLBLGen.EntityType.CustomerEntity, (int)AdventureWorksLLBLGen.EntityType.StoreEntity, 0, null, null, null, null, "Store", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.CustomerEntity; }
		}
