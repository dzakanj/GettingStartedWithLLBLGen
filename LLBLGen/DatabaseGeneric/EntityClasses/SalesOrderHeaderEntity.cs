...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _address, new PropertyChangedEventHandler(OnAddressPropertyChanged), "Address", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingBillToAddressIdStatic, true, new int[] { (int)SalesOrderHeaderFieldIndex.BillToAddressId });
		}
		...
		{
			SetupSync(relatedEntity, ref _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingBillToAddressIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.BillToAddressId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _address1, new PropertyChangedEventHandler(OnAddress1PropertyChanged), "Address1", "SalesOrderHeaders1", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingShipToAddressIdStatic, true, new int[] { (int)SalesOrderHeaderFieldIndex.ShipToAddressId });
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _shipMethod, new PropertyChangedEventHandler(OnShipMethodPropertyChanged), "ShipMethod", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, true, new int[] { (int)SalesOrderHeaderFieldIndex.ShipMethodId });
		}
		...
		{
			SetupSync(relatedEntity, ref _shipMethod, new PropertyChangedEventHandler( OnShipMethodPropertyChanged ), "ShipMethod", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.ShipMethodId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _creditCard, new PropertyChangedEventHandler(OnCreditCardPropertyChanged), "CreditCard", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.CreditCardEntityUsingCreditCardIdStatic, true, new int[] { (int)SalesOrderHeaderFieldIndex.CreditCardId });
		}
		...
		{
			SetupSync(relatedEntity, ref _creditCard, new PropertyChangedEventHandler( OnCreditCardPropertyChanged ), "CreditCard", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.CreditCardEntityUsingCreditCardIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.CreditCardId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _customer, new PropertyChangedEventHandler(OnCustomerPropertyChanged), "Customer", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.CustomerEntityUsingCustomerIdStatic, true, new int[] { (int)SalesOrderHeaderFieldIndex.CustomerId });
		}
		...
		{
			SetupSync(relatedEntity, ref _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.CustomerId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesPerson, new PropertyChangedEventHandler(OnSalesPersonPropertyChanged), "SalesPerson", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.SalesPersonEntityUsingSalesPersonIdStatic, true, new int[] { (int)SalesOrderHeaderFieldIndex.SalesPersonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", "SalesOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderRelations.SalesPersonEntityUsingSalesPersonIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderFieldIndex.SalesPersonId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderDetails")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderDetailEntity, 0, null, null, null, null, "SalesOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderSalesReasonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderSalesReasonEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaderSalesReasons")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderSalesReasonEntity, 0, null, null, null, null, "SalesOrderHeaderSalesReasons", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.AddressEntity, 0, null, null, null, null, "Address", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address1")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.AddressEntity, 0, null, null, null, null, "Address1", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipMethodEntityFactory))),	(IEntityRelation)GetRelationsForField("ShipMethod")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.ShipMethodEntity, 0, null, null, null, null, "ShipMethod", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CreditCardEntityFactory))),	(IEntityRelation)GetRelationsForField("CreditCard")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.CreditCardEntity, 0, null, null, null, null, "CreditCard", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyRateEntityFactory))),	(IEntityRelation)GetRelationsForField("CurrencyRate")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.CurrencyRateEntity, 0, null, null, null, null, "CurrencyRate", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customer")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.CustomerEntity, 0, null, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesTerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesTerritory")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, 0, null, null, null, null, "SalesTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity; }
		}
