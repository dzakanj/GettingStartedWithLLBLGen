...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductSubcategoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductSubcategoryEntityFactory))), (IEntityRelation)GetRelationsForField("ProductSubcategories")[0], (int)AdventureWorksLLBLGen.EntityType.ProductCategoryEntity, (int)AdventureWorksLLBLGen.EntityType.ProductSubcategoryEntity, 0, null, null, null, null, "ProductSubcategories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.ProductCategoryEntity; }
		}
