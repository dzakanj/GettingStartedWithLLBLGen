...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "ProductVendors", AdventureWorksLLBLGen.RelationClasses.StaticProductVendorRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)ProductVendorFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ProductVendors", AdventureWorksLLBLGen.RelationClasses.StaticProductVendorRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ProductVendorFieldIndex.ProductId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _vendor, new PropertyChangedEventHandler(OnVendorPropertyChanged), "Vendor", "ProductVendors", AdventureWorksLLBLGen.RelationClasses.StaticProductVendorRelations.VendorEntityUsingBusinessEntityIdStatic, true, new int[] { (int)ProductVendorFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", "ProductVendors", AdventureWorksLLBLGen.RelationClasses.StaticProductVendorRelations.VendorEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)ProductVendorFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorksLLBLGen.EntityType.ProductVendorEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UnitMeasureEntityFactory))),	(IEntityRelation)GetRelationsForField("UnitMeasure")[0], (int)AdventureWorksLLBLGen.EntityType.ProductVendorEntity, (int)AdventureWorksLLBLGen.EntityType.UnitMeasureEntity, 0, null, null, null, null, "UnitMeasure", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(VendorEntityFactory))),	(IEntityRelation)GetRelationsForField("Vendor")[0], (int)AdventureWorksLLBLGen.EntityType.ProductVendorEntity, (int)AdventureWorksLLBLGen.EntityType.VendorEntity, 0, null, null, null, null, "Vendor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.ProductVendorEntity; }
		}
