...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _productCategory, new PropertyChangedEventHandler(OnProductCategoryPropertyChanged), "ProductCategory", "ProductSubcategories", AdventureWorksLLBLGen.RelationClasses.StaticProductSubcategoryRelations.ProductCategoryEntityUsingProductCategoryIdStatic, true, new int[] { (int)ProductSubcategoryFieldIndex.ProductCategoryId });
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)AdventureWorksLLBLGen.EntityType.ProductSubcategoryEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductCategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductCategory")[0], (int)AdventureWorksLLBLGen.EntityType.ProductSubcategoryEntity, (int)AdventureWorksLLBLGen.EntityType.ProductCategoryEntity, 0, null, null, null, null, "ProductCategory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.ProductSubcategoryEntity; }
		}
