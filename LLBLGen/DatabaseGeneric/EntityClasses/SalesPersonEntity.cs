...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesTerritory, new PropertyChangedEventHandler(OnSalesTerritoryPropertyChanged), "SalesTerritory", "SalesPeople", AdventureWorksLLBLGen.RelationClasses.StaticSalesPersonRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new int[] { (int)SalesPersonFieldIndex.TerritoryId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", "SalesPeople", AdventureWorksLLBLGen.RelationClasses.StaticSalesPersonRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  }, new int[] { (int)SalesPersonFieldIndex.TerritoryId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "SalesPerson", AdventureWorksLLBLGen.RelationClasses.StaticSalesPersonRelations.EmployeeEntityUsingBusinessEntityIdStatic, true, new int[] { (int)SalesPersonFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "SalesPerson", AdventureWorksLLBLGen.RelationClasses.StaticSalesPersonRelations.EmployeeEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)SalesPersonFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaders")[0], (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, 0, null, null, null, null, "SalesOrderHeaders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<StoreEntity>(EntityFactoryCache2.GetEntityFactory(typeof(StoreEntityFactory))), (IEntityRelation)GetRelationsForField("Stores")[0], (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity, (int)AdventureWorksLLBLGen.EntityType.StoreEntity, 0, null, null, null, null, "Stores", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesTerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesTerritory")[0], (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity, (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, 0, null, null, null, null, "SalesTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), (IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity, (int)AdventureWorksLLBLGen.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity; }
		}
