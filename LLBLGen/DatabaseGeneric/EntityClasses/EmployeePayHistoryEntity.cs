...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "EmployeePayHistories", AdventureWorksLLBLGen.RelationClasses.StaticEmployeePayHistoryRelations.EmployeeEntityUsingBusinessEntityIdStatic, true, new int[] { (int)EmployeePayHistoryFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "EmployeePayHistories", AdventureWorksLLBLGen.RelationClasses.StaticEmployeePayHistoryRelations.EmployeeEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)EmployeePayHistoryFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorksLLBLGen.EntityType.EmployeePayHistoryEntity, (int)AdventureWorksLLBLGen.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.EmployeePayHistoryEntity; }
		}
