...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _currency, new PropertyChangedEventHandler(OnCurrencyPropertyChanged), "Currency", "CountryRegionCurrencies", AdventureWorksLLBLGen.RelationClasses.StaticCountryRegionCurrencyRelations.CurrencyEntityUsingCurrencyCodeStatic, true, new int[] { (int)CountryRegionCurrencyFieldIndex.CurrencyCode });
		}
		...
		{
			SetupSync(relatedEntity, ref _currency, new PropertyChangedEventHandler( OnCurrencyPropertyChanged ), "Currency", "CountryRegionCurrencies", AdventureWorksLLBLGen.RelationClasses.StaticCountryRegionCurrencyRelations.CurrencyEntityUsingCurrencyCodeStatic, true, new string[] {  }, new int[] { (int)CountryRegionCurrencyFieldIndex.CurrencyCode }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CountryRegionEntityFactory))),	(IEntityRelation)GetRelationsForField("CountryRegion")[0], (int)AdventureWorksLLBLGen.EntityType.CountryRegionCurrencyEntity, (int)AdventureWorksLLBLGen.EntityType.CountryRegionEntity, 0, null, null, null, null, "CountryRegion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CurrencyEntityFactory))),	(IEntityRelation)GetRelationsForField("Currency")[0], (int)AdventureWorksLLBLGen.EntityType.CountryRegionCurrencyEntity, (int)AdventureWorksLLBLGen.EntityType.CurrencyEntity, 0, null, null, null, null, "Currency", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.CountryRegionCurrencyEntity; }
		}
