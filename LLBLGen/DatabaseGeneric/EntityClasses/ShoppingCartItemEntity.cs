...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "ShoppingCartItems", AdventureWorksLLBLGen.RelationClasses.StaticShoppingCartItemRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)ShoppingCartItemFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ShoppingCartItems", AdventureWorksLLBLGen.RelationClasses.StaticShoppingCartItemRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ShoppingCartItemFieldIndex.ProductId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorksLLBLGen.EntityType.ShoppingCartItemEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.ShoppingCartItemEntity; }
		}
