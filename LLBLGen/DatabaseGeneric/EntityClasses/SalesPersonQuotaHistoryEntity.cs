...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesPerson, new PropertyChangedEventHandler(OnSalesPersonPropertyChanged), "SalesPerson", "SalesPersonQuotaHistories", AdventureWorksLLBLGen.RelationClasses.StaticSalesPersonQuotaHistoryRelations.SalesPersonEntityUsingBusinessEntityIdStatic, true, new int[] { (int)SalesPersonQuotaHistoryFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", "SalesPersonQuotaHistories", AdventureWorksLLBLGen.RelationClasses.StaticSalesPersonQuotaHistoryRelations.SalesPersonEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)SalesPersonQuotaHistoryFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorksLLBLGen.EntityType.SalesPersonQuotaHistoryEntity, (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SalesPersonQuotaHistoryEntity; }
		}
