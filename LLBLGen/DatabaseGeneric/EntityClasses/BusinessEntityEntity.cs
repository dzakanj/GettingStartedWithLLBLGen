...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _person, new PropertyChangedEventHandler(OnPersonPropertyChanged), "Person", "BusinessEntity", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityRelations.PersonEntityUsingBusinessEntityIdStatic, false, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "BusinessEntity", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityRelations.PersonEntityUsingBusinessEntityIdStatic, false, new string[] {  }, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _vendor, new PropertyChangedEventHandler(OnVendorPropertyChanged), "Vendor", "BusinessEntity", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityRelations.VendorEntityUsingBusinessEntityIdStatic, false, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", "BusinessEntity", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityRelations.VendorEntityUsingBusinessEntityIdStatic, false, new string[] {  }, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _store, new PropertyChangedEventHandler(OnStorePropertyChanged), "Store", "BusinessEntity", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityRelations.StoreEntityUsingBusinessEntityIdStatic, false, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _store, new PropertyChangedEventHandler( OnStorePropertyChanged ), "Store", "BusinessEntity", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityRelations.StoreEntityUsingBusinessEntityIdStatic, false, new string[] {  }, new int[] { (int)BusinessEntityFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<BusinessEntityAddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BusinessEntityAddressEntityFactory))), (IEntityRelation)GetRelationsForField("BusinessEntityAddresses")[0], (int)AdventureWorksLLBLGen.EntityType.BusinessEntityEntity, (int)AdventureWorksLLBLGen.EntityType.BusinessEntityAddressEntity, 0, null, null, null, null, "BusinessEntityAddresses", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<BusinessEntityContactEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BusinessEntityContactEntityFactory))), (IEntityRelation)GetRelationsForField("BusinessEntityContacts")[0], (int)AdventureWorksLLBLGen.EntityType.BusinessEntityEntity, (int)AdventureWorksLLBLGen.EntityType.BusinessEntityContactEntity, 0, null, null, null, null, "BusinessEntityContacts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PersonEntityFactory))), (IEntityRelation)GetRelationsForField("Person")[0], (int)AdventureWorksLLBLGen.EntityType.BusinessEntityEntity, (int)AdventureWorksLLBLGen.EntityType.PersonEntity, 0, null, null, null, null, "Person", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(VendorEntityFactory))), (IEntityRelation)GetRelationsForField("Vendor")[0], (int)AdventureWorksLLBLGen.EntityType.BusinessEntityEntity, (int)AdventureWorksLLBLGen.EntityType.VendorEntity, 0, null, null, null, null, "Vendor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StoreEntityFactory))), (IEntityRelation)GetRelationsForField("Store")[0], (int)AdventureWorksLLBLGen.EntityType.BusinessEntityEntity, (int)AdventureWorksLLBLGen.EntityType.StoreEntity, 0, null, null, null, null, "Store", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.BusinessEntityEntity; }
		}
