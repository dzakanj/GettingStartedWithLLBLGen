...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderSalesReasonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderSalesReasonEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaderSalesReasons")[0], (int)AdventureWorksLLBLGen.EntityType.SalesReasonEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderSalesReasonEntity, 0, null, null, null, null, "SalesOrderHeaderSalesReasons", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SalesReasonEntity; }
		}
