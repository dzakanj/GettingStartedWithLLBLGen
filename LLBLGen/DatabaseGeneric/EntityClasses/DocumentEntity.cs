...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		public IPredicateExpression ConstructFilterForUCRowguid()
		{
			...
			filter.Add(AdventureWorksLLBLGen.HelperClasses.DocumentFields.Rowguid == this.Fields.GetCurrentValue((int)DocumentFieldIndex.Rowguid));
 			return filter;
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _employee, new PropertyChangedEventHandler(OnEmployeePropertyChanged), "Employee", "Documents", AdventureWorksLLBLGen.RelationClasses.StaticDocumentRelations.EmployeeEntityUsingOwnerStatic, true, new int[] { (int)DocumentFieldIndex.Owner });
		}
		...
		{
			SetupSync(relatedEntity, ref _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", "Documents", AdventureWorksLLBLGen.RelationClasses.StaticDocumentRelations.EmployeeEntityUsingOwnerStatic, true, new string[] {  }, new int[] { (int)DocumentFieldIndex.Owner }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductDocumentEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductDocumentEntityFactory))), (IEntityRelation)GetRelationsForField("ProductDocuments")[0], (int)AdventureWorksLLBLGen.EntityType.DocumentEntity, (int)AdventureWorksLLBLGen.EntityType.ProductDocumentEntity, 0, null, null, null, null, "ProductDocuments", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorksLLBLGen.EntityType.DocumentEntity, (int)AdventureWorksLLBLGen.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.DocumentEntity; }
		}
