...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _stateProvince, new PropertyChangedEventHandler(OnStateProvincePropertyChanged), "StateProvince", "Addresses", AdventureWorksLLBLGen.RelationClasses.StaticAddressRelations.StateProvinceEntityUsingStateProvinceIdStatic, true, new int[] { (int)AddressFieldIndex.StateProvinceId });
		}
		...
		{
			SetupSync(relatedEntity, ref _stateProvince, new PropertyChangedEventHandler( OnStateProvincePropertyChanged ), "StateProvince", "Addresses", AdventureWorksLLBLGen.RelationClasses.StaticAddressRelations.StateProvinceEntityUsingStateProvinceIdStatic, true, new string[] {  }, new int[] { (int)AddressFieldIndex.StateProvinceId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<BusinessEntityAddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BusinessEntityAddressEntityFactory))), (IEntityRelation)GetRelationsForField("BusinessEntityAddresses")[0], (int)AdventureWorksLLBLGen.EntityType.AddressEntity, (int)AdventureWorksLLBLGen.EntityType.BusinessEntityAddressEntity, 0, null, null, null, null, "BusinessEntityAddresses", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaders")[0], (int)AdventureWorksLLBLGen.EntityType.AddressEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, 0, null, null, null, null, "SalesOrderHeaders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaders1")[0], (int)AdventureWorksLLBLGen.EntityType.AddressEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, 0, null, null, null, null, "SalesOrderHeaders1", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(StateProvinceEntityFactory))),	(IEntityRelation)GetRelationsForField("StateProvince")[0], (int)AdventureWorksLLBLGen.EntityType.AddressEntity, (int)AdventureWorksLLBLGen.EntityType.StateProvinceEntity, 0, null, null, null, null, "StateProvince", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String SpatialLocation
		{
			get { return (System.String)GetValue((int)AddressFieldIndex.SpatialLocation, true); }
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.AddressEntity; }
		}
