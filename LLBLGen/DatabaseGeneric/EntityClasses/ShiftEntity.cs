...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeDepartmentHistoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeDepartmentHistoryEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeDepartmentHistories")[0], (int)AdventureWorksLLBLGen.EntityType.ShiftEntity, (int)AdventureWorksLLBLGen.EntityType.EmployeeDepartmentHistoryEntity, 0, null, null, null, null, "EmployeeDepartmentHistories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.ShiftEntity; }
		}
