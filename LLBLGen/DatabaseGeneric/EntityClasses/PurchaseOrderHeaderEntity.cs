...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			SetupSync(relatedEntity, ref _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", "PurchaseOrderHeaders", AdventureWorksLLBLGen.RelationClasses.StaticPurchaseOrderHeaderRelations.VendorEntityUsingVendorIdStatic, true, new string[] {  }, new int[] { (int)PurchaseOrderHeaderFieldIndex.VendorId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<PurchaseOrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PurchaseOrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("PurchaseOrderDetails")[0], (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderDetailEntity, 0, null, null, null, null, "PurchaseOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipMethodEntityFactory))),	(IEntityRelation)GetRelationsForField("ShipMethod")[0], (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.ShipMethodEntity, 0, null, null, null, null, "ShipMethod", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(VendorEntityFactory))),	(IEntityRelation)GetRelationsForField("Vendor")[0], (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderHeaderEntity, (int)AdventureWorksLLBLGen.EntityType.VendorEntity, 0, null, null, null, null, "Vendor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.PurchaseOrderHeaderEntity; }
		}
