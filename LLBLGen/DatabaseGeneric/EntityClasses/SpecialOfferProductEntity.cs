...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "SpecialOfferProducts", AdventureWorksLLBLGen.RelationClasses.StaticSpecialOfferProductRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)SpecialOfferProductFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "SpecialOfferProducts", AdventureWorksLLBLGen.RelationClasses.StaticSpecialOfferProductRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)SpecialOfferProductFieldIndex.ProductId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _specialOffer, new PropertyChangedEventHandler(OnSpecialOfferPropertyChanged), "SpecialOffer", "SpecialOfferProducts", AdventureWorksLLBLGen.RelationClasses.StaticSpecialOfferProductRelations.SpecialOfferEntityUsingSpecialOfferIdStatic, true, new int[] { (int)SpecialOfferProductFieldIndex.SpecialOfferId });
		}
		...
		{
			SetupSync(relatedEntity, ref _specialOffer, new PropertyChangedEventHandler( OnSpecialOfferPropertyChanged ), "SpecialOffer", "SpecialOfferProducts", AdventureWorksLLBLGen.RelationClasses.StaticSpecialOfferProductRelations.SpecialOfferEntityUsingSpecialOfferIdStatic, true, new string[] {  }, new int[] { (int)SpecialOfferProductFieldIndex.SpecialOfferId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderDetails")[0], (int)AdventureWorksLLBLGen.EntityType.SpecialOfferProductEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderDetailEntity, 0, null, null, null, null, "SalesOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorksLLBLGen.EntityType.SpecialOfferProductEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SpecialOfferProductEntity; }
		}
