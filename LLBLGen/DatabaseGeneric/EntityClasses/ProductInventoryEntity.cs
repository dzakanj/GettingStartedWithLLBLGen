...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _location, new PropertyChangedEventHandler(OnLocationPropertyChanged), "Location", "ProductInventories", AdventureWorksLLBLGen.RelationClasses.StaticProductInventoryRelations.LocationEntityUsingLocationIdStatic, true, new int[] { (int)ProductInventoryFieldIndex.LocationId });
		}
		...
		{
			SetupSync(relatedEntity, ref _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", "ProductInventories", AdventureWorksLLBLGen.RelationClasses.StaticProductInventoryRelations.LocationEntityUsingLocationIdStatic, true, new string[] {  }, new int[] { (int)ProductInventoryFieldIndex.LocationId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "ProductInventories", AdventureWorksLLBLGen.RelationClasses.StaticProductInventoryRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)ProductInventoryFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ProductInventories", AdventureWorksLLBLGen.RelationClasses.StaticProductInventoryRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ProductInventoryFieldIndex.ProductId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(LocationEntityFactory))),	(IEntityRelation)GetRelationsForField("Location")[0], (int)AdventureWorksLLBLGen.EntityType.ProductInventoryEntity, (int)AdventureWorksLLBLGen.EntityType.LocationEntity, 0, null, null, null, null, "Location", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorksLLBLGen.EntityType.ProductInventoryEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.ProductInventoryEntity; }
		}
