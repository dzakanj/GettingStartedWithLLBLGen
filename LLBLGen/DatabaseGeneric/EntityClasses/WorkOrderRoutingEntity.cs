...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _location, new PropertyChangedEventHandler(OnLocationPropertyChanged), "Location", "WorkOrderRoutings", AdventureWorksLLBLGen.RelationClasses.StaticWorkOrderRoutingRelations.LocationEntityUsingLocationIdStatic, true, new int[] { (int)WorkOrderRoutingFieldIndex.LocationId });
		}
		...
		{
			SetupSync(relatedEntity, ref _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", "WorkOrderRoutings", AdventureWorksLLBLGen.RelationClasses.StaticWorkOrderRoutingRelations.LocationEntityUsingLocationIdStatic, true, new string[] {  }, new int[] { (int)WorkOrderRoutingFieldIndex.LocationId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _workOrder, new PropertyChangedEventHandler(OnWorkOrderPropertyChanged), "WorkOrder", "WorkOrderRoutings", AdventureWorksLLBLGen.RelationClasses.StaticWorkOrderRoutingRelations.WorkOrderEntityUsingWorkOrderIdStatic, true, new int[] { (int)WorkOrderRoutingFieldIndex.WorkOrderId });
		}
		...
		{
			SetupSync(relatedEntity, ref _workOrder, new PropertyChangedEventHandler( OnWorkOrderPropertyChanged ), "WorkOrder", "WorkOrderRoutings", AdventureWorksLLBLGen.RelationClasses.StaticWorkOrderRoutingRelations.WorkOrderEntityUsingWorkOrderIdStatic, true, new string[] {  }, new int[] { (int)WorkOrderRoutingFieldIndex.WorkOrderId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(LocationEntityFactory))),	(IEntityRelation)GetRelationsForField("Location")[0], (int)AdventureWorksLLBLGen.EntityType.WorkOrderRoutingEntity, (int)AdventureWorksLLBLGen.EntityType.LocationEntity, 0, null, null, null, null, "Location", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderEntityFactory))),	(IEntityRelation)GetRelationsForField("WorkOrder")[0], (int)AdventureWorksLLBLGen.EntityType.WorkOrderRoutingEntity, (int)AdventureWorksLLBLGen.EntityType.WorkOrderEntity, 0, null, null, null, null, "WorkOrder", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.WorkOrderRoutingEntity; }
		}
