...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesPerson, new PropertyChangedEventHandler(OnSalesPersonPropertyChanged), "SalesPerson", "Stores", AdventureWorksLLBLGen.RelationClasses.StaticStoreRelations.SalesPersonEntityUsingSalesPersonIdStatic, true, new int[] { (int)StoreFieldIndex.SalesPersonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", "Stores", AdventureWorksLLBLGen.RelationClasses.StaticStoreRelations.SalesPersonEntityUsingSalesPersonIdStatic, true, new string[] {  }, new int[] { (int)StoreFieldIndex.SalesPersonId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _businessEntity, new PropertyChangedEventHandler(OnBusinessEntityPropertyChanged), "BusinessEntity", "Store", AdventureWorksLLBLGen.RelationClasses.StaticStoreRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new int[] { (int)StoreFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", "Store", AdventureWorksLLBLGen.RelationClasses.StaticStoreRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)StoreFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), (IEntityRelation)GetRelationsForField("Customers")[0], (int)AdventureWorksLLBLGen.EntityType.StoreEntity, (int)AdventureWorksLLBLGen.EntityType.CustomerEntity, 0, null, null, null, null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorksLLBLGen.EntityType.StoreEntity, (int)AdventureWorksLLBLGen.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(BusinessEntityEntityFactory))), (IEntityRelation)GetRelationsForField("BusinessEntity")[0], (int)AdventureWorksLLBLGen.EntityType.StoreEntity, (int)AdventureWorksLLBLGen.EntityType.BusinessEntityEntity, 0, null, null, null, null, "BusinessEntity", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.StoreEntity; }
		}
