...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, false, ref _person, new PropertyChangedEventHandler(OnPersonPropertyChanged), "Person", "Password", AdventureWorksLLBLGen.RelationClasses.StaticPasswordRelations.PersonEntityUsingBusinessEntityIdStatic, true, new int[] { (int)PasswordFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "Password", AdventureWorksLLBLGen.RelationClasses.StaticPasswordRelations.PersonEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)PasswordFieldIndex.BusinessEntityId }); 
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PersonEntityFactory))), (IEntityRelation)GetRelationsForField("Person")[0], (int)AdventureWorksLLBLGen.EntityType.PasswordEntity, (int)AdventureWorksLLBLGen.EntityType.PersonEntity, 0, null, null, null, null, "Person", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.PasswordEntity; }
		}
