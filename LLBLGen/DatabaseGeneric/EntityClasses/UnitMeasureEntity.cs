...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<BillOfMaterialEntity>(EntityFactoryCache2.GetEntityFactory(typeof(BillOfMaterialEntityFactory))), (IEntityRelation)GetRelationsForField("BillOfMaterials")[0], (int)AdventureWorksLLBLGen.EntityType.UnitMeasureEntity, (int)AdventureWorksLLBLGen.EntityType.BillOfMaterialEntity, 0, null, null, null, null, "BillOfMaterials", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)AdventureWorksLLBLGen.EntityType.UnitMeasureEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products1")[0], (int)AdventureWorksLLBLGen.EntityType.UnitMeasureEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Products1", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductVendorEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductVendorEntityFactory))), (IEntityRelation)GetRelationsForField("ProductVendors")[0], (int)AdventureWorksLLBLGen.EntityType.UnitMeasureEntity, (int)AdventureWorksLLBLGen.EntityType.ProductVendorEntity, 0, null, null, null, null, "ProductVendors", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.UnitMeasureEntity; }
		}
