...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _businessEntity, new PropertyChangedEventHandler(OnBusinessEntityPropertyChanged), "BusinessEntity", "BusinessEntityContacts", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityContactRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new int[] { (int)BusinessEntityContactFieldIndex.BusinessEntityId });
		}
		...
		{
			SetupSync(relatedEntity, ref _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", "BusinessEntityContacts", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityContactRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new string[] {  }, new int[] { (int)BusinessEntityContactFieldIndex.BusinessEntityId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _contactType, new PropertyChangedEventHandler(OnContactTypePropertyChanged), "ContactType", "BusinessEntityContacts", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityContactRelations.ContactTypeEntityUsingContactTypeIdStatic, true, new int[] { (int)BusinessEntityContactFieldIndex.ContactTypeId });
		}
		...
		{
			SetupSync(relatedEntity, ref _contactType, new PropertyChangedEventHandler( OnContactTypePropertyChanged ), "ContactType", "BusinessEntityContacts", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityContactRelations.ContactTypeEntityUsingContactTypeIdStatic, true, new string[] {  }, new int[] { (int)BusinessEntityContactFieldIndex.ContactTypeId }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _person, new PropertyChangedEventHandler(OnPersonPropertyChanged), "Person", "BusinessEntityContacts", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityContactRelations.PersonEntityUsingPersonIdStatic, true, new int[] { (int)BusinessEntityContactFieldIndex.PersonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", "BusinessEntityContacts", AdventureWorksLLBLGen.RelationClasses.StaticBusinessEntityContactRelations.PersonEntityUsingPersonIdStatic, true, new string[] {  }, new int[] { (int)BusinessEntityContactFieldIndex.PersonId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(BusinessEntityEntityFactory))),	(IEntityRelation)GetRelationsForField("BusinessEntity")[0], (int)AdventureWorksLLBLGen.EntityType.BusinessEntityContactEntity, (int)AdventureWorksLLBLGen.EntityType.BusinessEntityEntity, 0, null, null, null, null, "BusinessEntity", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ContactTypeEntityFactory))),	(IEntityRelation)GetRelationsForField("ContactType")[0], (int)AdventureWorksLLBLGen.EntityType.BusinessEntityContactEntity, (int)AdventureWorksLLBLGen.EntityType.ContactTypeEntity, 0, null, null, null, null, "ContactType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PersonEntityFactory))),	(IEntityRelation)GetRelationsForField("Person")[0], (int)AdventureWorksLLBLGen.EntityType.BusinessEntityContactEntity, (int)AdventureWorksLLBLGen.EntityType.PersonEntity, 0, null, null, null, null, "Person", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.BusinessEntityContactEntity; }
		}
