...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesOrderHeader, new PropertyChangedEventHandler(OnSalesOrderHeaderPropertyChanged), "SalesOrderHeader", "SalesOrderHeaderSalesReasons", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesOrderHeaderEntityUsingSalesOrderIdStatic, true, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesOrderId });
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesReason, new PropertyChangedEventHandler(OnSalesReasonPropertyChanged), "SalesReason", "SalesOrderHeaderSalesReasons", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesReasonEntityUsingSalesReasonIdStatic, true, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesReason, new PropertyChangedEventHandler( OnSalesReasonPropertyChanged ), "SalesReason", "SalesOrderHeaderSalesReasons", AdventureWorksLLBLGen.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesReasonEntityUsingSalesReasonIdStatic, true, new string[] {  }, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesReasonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesReason")[0], (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderSalesReasonEntity, (int)AdventureWorksLLBLGen.EntityType.SalesReasonEntity, 0, null, null, null, null, "SalesReason", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderSalesReasonEntity; }
		}
