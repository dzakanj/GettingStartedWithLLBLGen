...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _countryRegion, new PropertyChangedEventHandler(OnCountryRegionPropertyChanged), "CountryRegion", "StateProvinces", AdventureWorksLLBLGen.RelationClasses.StaticStateProvinceRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, new int[] { (int)StateProvinceFieldIndex.CountryRegionCode });
		}
		...
		{
			SetupSync(relatedEntity, ref _countryRegion, new PropertyChangedEventHandler( OnCountryRegionPropertyChanged ), "CountryRegion", "StateProvinces", AdventureWorksLLBLGen.RelationClasses.StaticStateProvinceRelations.CountryRegionEntityUsingCountryRegionCodeStatic, true, new string[] {  }, new int[] { (int)StateProvinceFieldIndex.CountryRegionCode }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _salesTerritory, new PropertyChangedEventHandler(OnSalesTerritoryPropertyChanged), "SalesTerritory", "StateProvinces", AdventureWorksLLBLGen.RelationClasses.StaticStateProvinceRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new int[] { (int)StateProvinceFieldIndex.TerritoryId });
		}
		...
		{
			SetupSync(relatedEntity, ref _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", "StateProvinces", AdventureWorksLLBLGen.RelationClasses.StaticStateProvinceRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  }, new int[] { (int)StateProvinceFieldIndex.TerritoryId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AddressEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))), (IEntityRelation)GetRelationsForField("Addresses")[0], (int)AdventureWorksLLBLGen.EntityType.StateProvinceEntity, (int)AdventureWorksLLBLGen.EntityType.AddressEntity, 0, null, null, null, null, "Addresses", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesTaxRateEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesTaxRateEntityFactory))), (IEntityRelation)GetRelationsForField("SalesTaxRates")[0], (int)AdventureWorksLLBLGen.EntityType.StateProvinceEntity, (int)AdventureWorksLLBLGen.EntityType.SalesTaxRateEntity, 0, null, null, null, null, "SalesTaxRates", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CountryRegionEntityFactory))),	(IEntityRelation)GetRelationsForField("CountryRegion")[0], (int)AdventureWorksLLBLGen.EntityType.StateProvinceEntity, (int)AdventureWorksLLBLGen.EntityType.CountryRegionEntity, 0, null, null, null, null, "CountryRegion", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesTerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesTerritory")[0], (int)AdventureWorksLLBLGen.EntityType.StateProvinceEntity, (int)AdventureWorksLLBLGen.EntityType.SalesTerritoryEntity, 0, null, null, null, null, "SalesTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.StateProvinceEntity; }
		}
