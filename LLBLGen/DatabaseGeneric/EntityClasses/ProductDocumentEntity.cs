...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			SetupSync(relatedEntity, ref _document, new PropertyChangedEventHandler( OnDocumentPropertyChanged ), "Document", "ProductDocuments", AdventureWorksLLBLGen.RelationClasses.StaticProductDocumentRelations.DocumentEntityUsingDocumentNodeStatic, true, new string[] {  }, new int[] { (int)ProductDocumentFieldIndex.DocumentNode }); 
		}
		...
		{
			DesetupSync(signalRelatedEntity, resetFKFields, ref _product, new PropertyChangedEventHandler(OnProductPropertyChanged), "Product", "ProductDocuments", AdventureWorksLLBLGen.RelationClasses.StaticProductDocumentRelations.ProductEntityUsingProductIdStatic, true, new int[] { (int)ProductDocumentFieldIndex.ProductId });
		}
		...
		{
			SetupSync(relatedEntity, ref _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", "ProductDocuments", AdventureWorksLLBLGen.RelationClasses.StaticProductDocumentRelations.ProductEntityUsingProductIdStatic, true, new string[] {  }, new int[] { (int)ProductDocumentFieldIndex.ProductId }); 
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(DocumentEntityFactory))),	(IEntityRelation)GetRelationsForField("Document")[0], (int)AdventureWorksLLBLGen.EntityType.ProductDocumentEntity, (int)AdventureWorksLLBLGen.EntityType.DocumentEntity, 0, null, null, null, null, "Document", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorksLLBLGen.EntityType.ProductDocumentEntity, (int)AdventureWorksLLBLGen.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.ProductDocumentEntity; }
		}
