...
namespace AdventureWorksLLBLGen.EntityClasses
{
			...
			
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<PersonCreditCardEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PersonCreditCardEntityFactory))), (IEntityRelation)GetRelationsForField("PersonCreditCards")[0], (int)AdventureWorksLLBLGen.EntityType.CreditCardEntity, (int)AdventureWorksLLBLGen.EntityType.PersonCreditCardEntity, 0, null, null, null, null, "PersonCreditCards", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaders")[0], (int)AdventureWorksLLBLGen.EntityType.CreditCardEntity, (int)AdventureWorksLLBLGen.EntityType.SalesOrderHeaderEntity, 0, null, null, null, null, "SalesOrderHeaders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorksLLBLGen.EntityType.CreditCardEntity; }
		}
