...
namespace AdventureWorksLLBLGen.FactoryClasses
{
	...
	{
		private static readonly Dictionary<AdventureWorksLLBLGen.EntityType, string> _entityTypeNamesCache = new Dictionary<AdventureWorksLLBLGen.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(AdventureWorksLLBLGen.EntityType value in Enum.GetValues(typeof(AdventureWorksLLBLGen.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(AdventureWorksLLBLGen.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(AdventureWorksLLBLGen.EntityType relatedEntityType)
		{
