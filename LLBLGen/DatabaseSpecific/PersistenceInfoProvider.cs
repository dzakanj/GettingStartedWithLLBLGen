...
namespace AdventureWorksLLBLGen.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			this.AddElementMapping("DepartmentEntity", @"AdventureWorks2016", @"HumanResources", "Department", 4, 0);
		...
		{
			this.AddElementMapping("EmployeeEntity", @"AdventureWorks2016", @"HumanResources", "Employee", 16, 0);
		...
		{
			this.AddElementMapping("EmployeeDepartmentHistoryEntity", @"AdventureWorks2016", @"HumanResources", "EmployeeDepartmentHistory", 6, 0);
		...
		{
			this.AddElementMapping("EmployeePayHistoryEntity", @"AdventureWorks2016", @"HumanResources", "EmployeePayHistory", 5, 0);
		...
		{
			this.AddElementMapping("JobCandidateEntity", @"AdventureWorks2016", @"HumanResources", "JobCandidate", 4, 0);
		...
		{
			this.AddElementMapping("ShiftEntity", @"AdventureWorks2016", @"HumanResources", "Shift", 5, 0);
		...
		{
			this.AddElementMapping("AddressEntity", @"AdventureWorks2016", @"Person", "Address", 9, 0);
			...
			this.AddElementFieldMapping("AddressEntity", "SpatialLocation", "SpatialLocation", true, "VarChar", 2147483647, 0, 0, false, "", null, typeof(System.String), 7);
		...
		{
			this.AddElementMapping("AddressTypeEntity", @"AdventureWorks2016", @"Person", "AddressType", 4, 0);
		...
		{
			this.AddElementMapping("BusinessEntityEntity", @"AdventureWorks2016", @"Person", "BusinessEntity", 3, 0);
		...
		{
			this.AddElementMapping("BusinessEntityAddressEntity", @"AdventureWorks2016", @"Person", "BusinessEntityAddress", 5, 0);
		...
		{
			this.AddElementMapping("BusinessEntityContactEntity", @"AdventureWorks2016", @"Person", "BusinessEntityContact", 5, 0);
		...
		{
			this.AddElementMapping("ContactTypeEntity", @"AdventureWorks2016", @"Person", "ContactType", 3, 0);
		...
		{
			this.AddElementMapping("CountryRegionEntity", @"AdventureWorks2016", @"Person", "CountryRegion", 3, 0);
		...
		{
			this.AddElementMapping("EmailAddressEntity", @"AdventureWorks2016", @"Person", "EmailAddress", 5, 0);
		...
		{
			this.AddElementMapping("PasswordEntity", @"AdventureWorks2016", @"Person", "Password", 5, 0);
		...
		{
			this.AddElementMapping("PersonEntity", @"AdventureWorks2016", @"Person", "Person", 13, 0);
		...
		{
			this.AddElementMapping("PersonPhoneEntity", @"AdventureWorks2016", @"Person", "PersonPhone", 4, 0);
		...
		{
			this.AddElementMapping("PhoneNumberTypeEntity", @"AdventureWorks2016", @"Person", "PhoneNumberType", 3, 0);
		...
		{
			this.AddElementMapping("StateProvinceEntity", @"AdventureWorks2016", @"Person", "StateProvince", 8, 0);
		...
		{
			this.AddElementMapping("BillOfMaterialEntity", @"AdventureWorks2016", @"Production", "BillOfMaterials", 9, 0);
		...
		{
			this.AddElementMapping("CultureEntity", @"AdventureWorks2016", @"Production", "Culture", 3, 0);
		...
		{
			this.AddElementMapping("DocumentEntity", @"AdventureWorks2016", @"Production", "Document", 14, 0);
		...
		{
			this.AddElementMapping("IllustrationEntity", @"AdventureWorks2016", @"Production", "Illustration", 3, 0);
		...
		{
			this.AddElementMapping("LocationEntity", @"AdventureWorks2016", @"Production", "Location", 5, 0);
		...
		{
			this.AddElementMapping("ProductEntity", @"AdventureWorks2016", @"Production", "Product", 25, 0);
		...
		{
			this.AddElementMapping("ProductCategoryEntity", @"AdventureWorks2016", @"Production", "ProductCategory", 4, 0);
		...
		{
			this.AddElementMapping("ProductCostHistoryEntity", @"AdventureWorks2016", @"Production", "ProductCostHistory", 5, 0);
		...
		{
			this.AddElementMapping("ProductDescriptionEntity", @"AdventureWorks2016", @"Production", "ProductDescription", 4, 0);
		...
		{
			this.AddElementMapping("ProductDocumentEntity", @"AdventureWorks2016", @"Production", "ProductDocument", 3, 0);
		...
		{
			this.AddElementMapping("ProductInventoryEntity", @"AdventureWorks2016", @"Production", "ProductInventory", 7, 0);
		...
		{
			this.AddElementMapping("ProductListPriceHistoryEntity", @"AdventureWorks2016", @"Production", "ProductListPriceHistory", 5, 0);
		...
		{
			this.AddElementMapping("ProductModelEntity", @"AdventureWorks2016", @"Production", "ProductModel", 6, 0);
		...
		{
			this.AddElementMapping("ProductModelIllustrationEntity", @"AdventureWorks2016", @"Production", "ProductModelIllustration", 3, 0);
		...
		{
			this.AddElementMapping("ProductModelProductDescriptionCultureEntity", @"AdventureWorks2016", @"Production", "ProductModelProductDescriptionCulture", 4, 0);
		...
		{
			this.AddElementMapping("ProductPhotoEntity", @"AdventureWorks2016", @"Production", "ProductPhoto", 6, 0);
		...
		{
			this.AddElementMapping("ProductProductPhotoEntity", @"AdventureWorks2016", @"Production", "ProductProductPhoto", 4, 0);
		...
		{
			this.AddElementMapping("ProductReviewEntity", @"AdventureWorks2016", @"Production", "ProductReview", 8, 0);
		...
		{
			this.AddElementMapping("ProductSubcategoryEntity", @"AdventureWorks2016", @"Production", "ProductSubcategory", 5, 0);
		...
		{
			this.AddElementMapping("ScrapReasonEntity", @"AdventureWorks2016", @"Production", "ScrapReason", 3, 0);
		...
		{
			this.AddElementMapping("TransactionHistoryEntity", @"AdventureWorks2016", @"Production", "TransactionHistory", 9, 0);
		...
		{
			this.AddElementMapping("TransactionHistoryArchiveEntity", @"AdventureWorks2016", @"Production", "TransactionHistoryArchive", 9, 0);
		...
		{
			this.AddElementMapping("UnitMeasureEntity", @"AdventureWorks2016", @"Production", "UnitMeasure", 3, 0);
		...
		{
			this.AddElementMapping("WorkOrderEntity", @"AdventureWorks2016", @"Production", "WorkOrder", 10, 0);
		...
		{
			this.AddElementMapping("WorkOrderRoutingEntity", @"AdventureWorks2016", @"Production", "WorkOrderRouting", 12, 0);
		...
		{
			this.AddElementMapping("ProductVendorEntity", @"AdventureWorks2016", @"Purchasing", "ProductVendor", 11, 0);
		...
		{
			this.AddElementMapping("PurchaseOrderDetailEntity", @"AdventureWorks2016", @"Purchasing", "PurchaseOrderDetail", 11, 0);
		...
		{
			this.AddElementMapping("PurchaseOrderHeaderEntity", @"AdventureWorks2016", @"Purchasing", "PurchaseOrderHeader", 13, 0);
		...
		{
			this.AddElementMapping("ShipMethodEntity", @"AdventureWorks2016", @"Purchasing", "ShipMethod", 6, 0);
		...
		{
			this.AddElementMapping("VendorEntity", @"AdventureWorks2016", @"Purchasing", "Vendor", 8, 0);
		...
		{
			this.AddElementMapping("CountryRegionCurrencyEntity", @"AdventureWorks2016", @"Sales", "CountryRegionCurrency", 3, 0);
		...
		{
			this.AddElementMapping("CreditCardEntity", @"AdventureWorks2016", @"Sales", "CreditCard", 6, 0);
		...
		{
			this.AddElementMapping("CurrencyEntity", @"AdventureWorks2016", @"Sales", "Currency", 3, 0);
		...
		{
			this.AddElementMapping("CurrencyRateEntity", @"AdventureWorks2016", @"Sales", "CurrencyRate", 7, 0);
		...
		{
			this.AddElementMapping("CustomerEntity", @"AdventureWorks2016", @"Sales", "Customer", 7, 0);
		...
		{
			this.AddElementMapping("PersonCreditCardEntity", @"AdventureWorks2016", @"Sales", "PersonCreditCard", 3, 0);
		...
		{
			this.AddElementMapping("SalesOrderDetailEntity", @"AdventureWorks2016", @"Sales", "SalesOrderDetail", 11, 0);
		...
		{
			this.AddElementMapping("SalesOrderHeaderEntity", @"AdventureWorks2016", @"Sales", "SalesOrderHeader", 26, 0);
		...
		{
			this.AddElementMapping("SalesOrderHeaderSalesReasonEntity", @"AdventureWorks2016", @"Sales", "SalesOrderHeaderSalesReason", 3, 0);
		...
		{
			this.AddElementMapping("SalesPersonEntity", @"AdventureWorks2016", @"Sales", "SalesPerson", 9, 0);
		...
		{
			this.AddElementMapping("SalesPersonQuotaHistoryEntity", @"AdventureWorks2016", @"Sales", "SalesPersonQuotaHistory", 5, 0);
		...
		{
			this.AddElementMapping("SalesReasonEntity", @"AdventureWorks2016", @"Sales", "SalesReason", 4, 0);
		...
		{
			this.AddElementMapping("SalesTaxRateEntity", @"AdventureWorks2016", @"Sales", "SalesTaxRate", 7, 0);
		...
		{
			this.AddElementMapping("SalesTerritoryEntity", @"AdventureWorks2016", @"Sales", "SalesTerritory", 10, 0);
		...
		{
			this.AddElementMapping("SalesTerritoryHistoryEntity", @"AdventureWorks2016", @"Sales", "SalesTerritoryHistory", 6, 0);
		...
		{
			this.AddElementMapping("ShoppingCartItemEntity", @"AdventureWorks2016", @"Sales", "ShoppingCartItem", 6, 0);
		...
		{
			this.AddElementMapping("SpecialOfferEntity", @"AdventureWorks2016", @"Sales", "SpecialOffer", 11, 0);
		...
		{
			this.AddElementMapping("SpecialOfferProductEntity", @"AdventureWorks2016", @"Sales", "SpecialOfferProduct", 4, 0);
		...
		{
			this.AddElementMapping("StoreEntity", @"AdventureWorks2016", @"Sales", "Store", 6, 0);
